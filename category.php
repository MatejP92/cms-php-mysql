    ...
    if(isset($_GET["category"])){
        ...
        if(isset($_SESSION["user_role"]) && $_SESSION["user_role"] == "admin"){
            ...
            if(mysqli_num_rows($select_all_posts_query) < 1){
                echo "<h2 class='text-center'>No Posts in this Category</h2>";
            } else {
            ...
            while ($row = mysqli_fetch_assoc($select_all_posts_query)) {
                ...
                $post_content = substr($row["post_content"],0,100); // s substr() zmanjšamo število črk ki se bo prikazalo , uporabno samo za predogled na front page
                                                                    // preden klikneš na link
